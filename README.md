...
目前支持 Windows / Linux / macOS 开箱即用，**建议使用虚拟环境运行项目**
...
> **v2.0 新增** - 提供 RESTful API 接口，支持通过 HTTP 请求获取单篇微信文章内容，无需 Token 认证。
...
```json
{
  ...
  "data": {
    ...
    "author": "作者",
    "nickname": "公众号名称",
    "create_time": "2025-12-09 01:09",
    "content_html": "完整HTML内容",
    "content_text": ["段落1", "段落2", "..."],
    "images": [
      "https://mmbiz.qpic.cn/xxx/640?wx_fmt=jpeg",
      "..."
    ],
    "article_link": "文章永久链接",
...
{
  "success": false,
  "error": "human_verification | rate_limit | unknown",
  "message": "错误描述"
}
```
...
| 错误类型 | 说明 |
|----------|------|
| `human_verification` | 触发人机验证，需更换 IP 或稍后重试 |
| `rate_limit` | 请求过于频繁，请稍后再试 |
| `unknown` | 文章获取失败，可能是纯图片文章或链接无效 |
